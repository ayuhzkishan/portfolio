...
const POSTS = [
  {
    id: 'POST-001',
    cat: 'Cloud · Security',
    title: 'Hardening Kubernetes Clusters: A Production Guide',
    excerpt: 'A deep-dive into network policies, role-based access control (RBAC), and secure secrets management in cloud environments.',
    date: '2024-03-15',
    time: '8 min',
  ...
  },
  {
    id: 'POST-002',
    cat: 'DevSecOps',
    title: 'Automating SAST/DAST in Git Workflows',
    excerpt: 'How to build an automated, security-first delivery pipeline for cloud-native applications using GitHub Actions and Docker.',
    date: '2024-03-10',
    time: '6 min',
